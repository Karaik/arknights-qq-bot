...
public class RoguelikeAuthService {
    ...
    public AuthFlow authenticate(String userKey, String hyperToken) {
        ...
        log.debug("event=auth.oauth-code.request userKey={}", userKey);
        ...
        log.debug("event=auth.oauth-code.success userKey={} code={}", userKey, codeResponse.data().code());
        ...
        log.debug("event=auth.binding.request userKey={}", userKey);
        ...
        log.info("event=auth.success userKey={} resolvedUid={}", userKey, uid);
